  ...
  return (
    <div className="blog-container">
      <Card
        ...
        body="Redux is an open-source JavaScript library for managing and centralizing application state."
      ...
      <Card
        ...
        title="React-Router"
        body="React Router is a standard library for routing in React. It enables the navigation among views of various components in a React Application."
